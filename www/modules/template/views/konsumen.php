                            ...
                            <li class="divider-vertical hidden-phone hidden-tablet"></li>
                            	<li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
										<li><a href="<?=base_url()?>auth/change_password"><i class="splashy-contact_blue_edit"></i> Pengaturan Profile</a></li>
										<li><a href="<?=base_url()?>auth/change_password"><i class="splashy-folder_stuffed_locked"></i> Ubah Password</a></li>
										<li class="divider"></li>
