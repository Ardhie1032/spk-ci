                            ...
                            <nav>
                                <div class="nav-collapse">
                                    ...
                                    <li class="dropdown">
                                            ...
                                            <i class="splashy-view_table"></i> Master<b class="caret"></b></a>
                                            <ul class="dropdown-menu">
                                                <li><a href="#"><i class="splashy-documents_okay"></i> Data Perawat</a></li>
                                                <li><a href="<?=site_url()?>/pelanggan"><i class="splashy-documents_okay"></i> Data Pelanggan</a></li>
                                                <li><a href="#"><i class="splashy-document_letter_edit"></i> Data Pertanyaan</a>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
